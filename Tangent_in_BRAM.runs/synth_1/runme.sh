...
HD_PWD='C:/Users/User/ACTIVATION FUNCTION/Tangent_in_BRAM/Tangent_in_BRAM.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Tangent.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Tangent.tcl
