...
HD_PWD='C:/Users/User/ACTIVATION FUNCTION/Tangent_in_BRAM/Tangent_in_BRAM.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Tangent.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Tangent.tcl -notrace
